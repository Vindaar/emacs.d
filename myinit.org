...
(push 'gemini-2.5-pro-preview-05-06 (gptel-backend-models (gptel-get-backend "Gemini")))
(put 'gemini-2.5-pro-preview-05-06 :capabilities '(tool-use json media))
(put 'gemini-2.5-pro-preview-05-06 :mime-types '("image/png" "image/jpeg" "image/webp" "image/heic" "image/heif"
                                         "application/pdf" "text/plain" "text/csv" "text/html"))
...
#+RESULTS:
: #s(gptel-openai "xAI" "api.x.ai" #<subr F616e6f6e796d6f75732d6c616d626461_anonymous_lambda_30> "https" t "/v1/chat/completions" gptel-xai-api-key (grok-3-latest grok-3-fast-latest grok-3-mini-latest grok-3-mini-fast-latest grok-2-vision-1212) "https://api.x.ai/v1/chat/completions" nil nil)
