...
(defun prev-window ()
  ...
  (other-window -1))
#+END_SRC
Unset org-cycle-agenda-files from "C-,", since we don't use it at the
moment. Do we have to unset it both for global and local?
#+BEGIN_SRC emacs-lisp
(global-unset-key (kbd "C-,"))
(local-unset-key (kbd "C-,"))
#+END_SRC
Then define our new keybindings for window moving:
#+BEGIN_SRC emacs-lisp
