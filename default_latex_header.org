...
# package that allows inserting unicode characters in math
# environment. Part of our default nowadays (for org latex preview)
...
# #+LATEX_HEADER: \usepackage[outputdir=texout]{minted}
